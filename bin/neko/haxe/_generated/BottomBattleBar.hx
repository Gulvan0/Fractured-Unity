...
class BottomBattleBar extends MovieClip {
	...
	public function new () {
		...
		*/
		...
		var symbol = swfLite.symbols.get (128);
...
#else
@:bind @:native("BottomBattleBar") class BottomBattleBar extends flash.display.MovieClip {
