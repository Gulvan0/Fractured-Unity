...
class CircleAbilityMask extends MovieClip {
	...
	public function new () {
		...
		*/
		...
		var symbol = swfLite.symbols.get (59);
...
#else
@:bind @:native("CircleAbilityMask") class CircleAbilityMask extends flash.display.MovieClip {
