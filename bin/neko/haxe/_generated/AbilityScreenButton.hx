...
class AbilityScreenButton extends MovieClip {
	...
	public function new () {
		...
		*/
		...
		var symbol = swfLite.symbols.get (87);
...
#else
@:bind @:native("AbilityScreenButton") class AbilityScreenButton extends flash.display.MovieClip {
