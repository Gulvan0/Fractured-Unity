...
bool TransformActuator_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0ad97490) {
		...
		return inClassId==(int)0x3b14e749;
	}
}
...
HXDLIN( 137)				details =  ::motion::actuators::PropertyDetails_obj::__alloc( HX_CTX ,details1,propertyName,start,(value4 - start),null());
...
HXDLIN( 160)			 ::openfl::media::SoundTransform _hx_tmp1 = this->tweenSoundTransform;
HXDLIN( 160)			Float start1 = start->volume;
HXDLIN( 160)			_hx_tmp->push( ::motion::actuators::PropertyDetails_obj::__alloc( HX_CTX ,_hx_tmp1,HX_("volume",da,29,53,5f),start1,(this->endSoundTransform->volume - start->volume),null()));
            		}
...
HXLINE( 167)			::Array< ::Dynamic> _hx_tmp2 = this->propertyDetails;
HXDLIN( 167)			 ::openfl::media::SoundTransform _hx_tmp3 = this->tweenSoundTransform;
HXDLIN( 167)			Float start2 = start->pan;
HXDLIN( 167)			_hx_tmp2->push( ::motion::actuators::PropertyDetails_obj::__alloc( HX_CTX ,_hx_tmp3,HX_("pan",5d,51,55,00),start2,(this->endSoundTransform->pan - start->pan),null()));
            		}
            	}
...
{
	hx::Object *dummy = new TransformActuator_obj;
	TransformActuator_obj::_hx_vtable = *(void **)dummy;
