...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_1060_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",1060,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_1060_new)
HXLINE(1062)		this->initFrame = initFrame;
HXLINE(1063)		this->initFrameObjectID = initFrameObjectID;
HXLINE(1064)		this->characterID = characterID;
HXLINE(1065)		this->depth = depth;
HXLINE(1066)		this->displayObject = displayObject;
HXLINE(1067)		this->clipDepth = clipDepth;
            	}
