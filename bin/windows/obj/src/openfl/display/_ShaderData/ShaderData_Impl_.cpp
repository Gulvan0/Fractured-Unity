...
HX_LOCAL_STACK_FRAME(_hx_pos_d4a02bef177fd982_17__new,"openfl.display._ShaderData.ShaderData_Impl_","_new",0xf95c2d76,"openfl.display._ShaderData.ShaderData_Impl_._new","openfl/display/ShaderData.hx",17,0xa8261943)
namespace openfl{
namespace display{
...
bool ShaderData_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ShaderData_Impl__obj::_new( ::openfl::utils::ByteArrayData byteArray){
            	HX_STACKFRAME(&_hx_pos_d4a02bef177fd982_17__new)
HXDLIN(  17)		 ::Dynamic this1 =  ::Dynamic(hx::Anon_obj::Create(0));
