...
HX_LOCAL_STACK_FRAME(_hx_pos_1b7c318d3e4ffa4a_352_loader_onError,"openfl.display.Loader","loader_onError",0x53aca80e,"openfl.display.Loader.loader_onError","openfl/display/Loader.hx",352,0x7a569d9f)
HX_LOCAL_STACK_FRAME(_hx_pos_1b7c318d3e4ffa4a_362_loader_onProgress,"openfl.display.Loader","loader_onProgress",0xfc1e8b27,"openfl.display.Loader.loader_onProgress","openfl/display/Loader.hx",362,0x7a569d9f)
namespace openfl{
namespace display{
...
HXLINE( 344)				this->contentLoaderInfo->bytes = ( ( ::openfl::utils::ByteArrayData)(loader->data) );
HXLINE( 345)				::openfl::display::BitmapData_obj::loadFromBytes(( ( ::openfl::utils::ByteArrayData)(loader->data) ),null())->onComplete(this->BitmapData_onLoad_dyn())->onError(this->BitmapData_onError_dyn());
            			}
            		}
            	}
...
void Loader_obj::loader_onError( ::openfl::events::IOErrorEvent event){
            	HX_STACKFRAME(&_hx_pos_1b7c318d3e4ffa4a_352_loader_onError)
HXLINE( 356)		event->target = this->contentLoaderInfo;
HXLINE( 357)		this->contentLoaderInfo->dispatchEvent(event);
            	}
...
void Loader_obj::loader_onProgress( ::openfl::events::ProgressEvent event){
            	HX_STACKFRAME(&_hx_pos_1b7c318d3e4ffa4a_362_loader_onProgress)
HXLINE( 364)		event->target = this->contentLoaderInfo;
HXLINE( 365)		this->contentLoaderInfo->dispatchEvent(event);
            	}
