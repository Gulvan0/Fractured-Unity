...
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_51_add,"lime.utils.ObjectPool_openfl_geom_Matrix","add",0xf753b556,"lime.utils.ObjectPool_openfl_geom_Matrix.add","lime/utils/ObjectPool.hx",51,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_62___default_clean,"lime.utils.ObjectPool_openfl_geom_Matrix","__default_clean",0x82d58fe0,"lime.utils.ObjectPool_openfl_geom_Matrix.__default_clean","lime/utils/ObjectPool.hx",62,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_69_clear,"lime.utils.ObjectPool_openfl_geom_Matrix","clear",0x67c42c02,"lime.utils.ObjectPool_openfl_geom_Matrix.clear","lime/utils/ObjectPool.hx",69,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_85___default_create,"lime.utils.ObjectPool_openfl_geom_Matrix","__default_create",0x6c6fd4c5,"lime.utils.ObjectPool_openfl_geom_Matrix.__default_create","lime/utils/ObjectPool.hx",85,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_90_get,"lime.utils.ObjectPool_openfl_geom_Matrix","get",0xf75843cb,"lime.utils.ObjectPool_openfl_geom_Matrix.get","lime/utils/ObjectPool.hx",90,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_116_release,"lime.utils.ObjectPool_openfl_geom_Matrix","release",0xafd1877c,"lime.utils.ObjectPool_openfl_geom_Matrix.release","lime/utils/ObjectPool.hx",116,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_146___addInactive,"lime.utils.ObjectPool_openfl_geom_Matrix","__addInactive",0x7a0c4701,"lime.utils.ObjectPool_openfl_geom_Matrix.__addInactive","lime/utils/ObjectPool.hx",146,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_171___getInactive,"lime.utils.ObjectPool_openfl_geom_Matrix","__getInactive",0x6ea3d276,"lime.utils.ObjectPool_openfl_geom_Matrix.__getInactive","lime/utils/ObjectPool.hx",171,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_215___removeInactive,"lime.utils.ObjectPool_openfl_geom_Matrix","__removeInactive",0x54807e9a,"lime.utils.ObjectPool_openfl_geom_Matrix.__removeInactive","lime/utils/ObjectPool.hx",215,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_264_get_size,"lime.utils.ObjectPool_openfl_geom_Matrix","get_size",0x7cabd8f5,"lime.utils.ObjectPool_openfl_geom_Matrix.get_size","lime/utils/ObjectPool.hx",264,0xc114d76b)
HX_LOCAL_STACK_FRAME(_hx_pos_41782c565fbd7fd5_269_set_size,"lime.utils.ObjectPool_openfl_geom_Matrix","set_size",0x2b093269,"lime.utils.ObjectPool_openfl_geom_Matrix.set_size","lime/utils/ObjectPool.hx",269,0xc114d76b)
namespace lime{
namespace utils{
...
void ObjectPool_openfl_geom_Matrix_obj::add( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_51_add)
...
void _hx_run( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_62___default_clean)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

void ObjectPool_openfl_geom_Matrix_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_41782c565fbd7fd5_69_clear)
...
HX_BEGIN_DEFAULT_FUNC(__default_create,ObjectPool_openfl_geom_Matrix_obj)
 ::openfl::geom::Matrix _hx_run(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_85___default_create)
...
HX_END_DEFAULT_FUNC
 ...
 ::openfl::geom::Matrix ObjectPool_openfl_geom_Matrix_obj::get(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_90_get)
HXLINE(  92)		 ::openfl::geom::Matrix object = null();
HXLINE(  94)		if ((this->inactiveObjects > (int)0)) {
HXLINE(  96)			 ::openfl::geom::Matrix object1 = null();
...
HXLINE(  96)					object1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
HXDLIN(  96)					if ((this->_hx___inactiveObjectList->length > (int)0)) {
HXLINE(  96)						this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
            					}
HXDLIN(  96)					if ((this->_hx___inactiveObjectList->length > (int)0)) {
HXLINE(  96)						this->_hx___inactiveObject1 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
            					}
            				}
            			}
...
HXLINE( 100)				object = ( ( ::openfl::geom::Matrix)(this->create()) );
...
void ObjectPool_openfl_geom_Matrix_obj::release( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_116_release)
...
void ObjectPool_openfl_geom_Matrix_obj::_hx___addInactive( ::openfl::geom::Matrix object){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_146___addInactive)
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Matrix_obj,_hx___addInactive,(void))
 ...
 ::openfl::geom::Matrix ObjectPool_openfl_geom_Matrix_obj::_hx___getInactive(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_171___getInactive)
HXLINE( 173)		 ::openfl::geom::Matrix object = null();
...
HXLINE( 187)				object = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
HXLINE( 189)				if ((this->_hx___inactiveObjectList->length > (int)0)) {
HXLINE( 191)					this->_hx___inactiveObject0 = this->_hx___inactiveObjectList->pop().StaticCast<  ::openfl::geom::Matrix >();
            				}
...
void ObjectPool_openfl_geom_Matrix_obj::_hx___removeInactive(int count){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_215___removeInactive)
...
HXLINE( 241)				 ::openfl::geom::Matrix val = ( ( ::openfl::geom::Matrix)(_g_head->item) );
HXDLIN( 241)				_g_head = _g_head->next;
HXDLIN( 241)				 ::openfl::geom::Matrix object = val;
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_openfl_geom_Matrix_obj,_hx___removeInactive,(void))
 ...
 ::Dynamic ObjectPool_openfl_geom_Matrix_obj::get_size(){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_264_get_size)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectPool_openfl_geom_Matrix_obj,get_size,return )
 ...
 ::Dynamic ObjectPool_openfl_geom_Matrix_obj::set_size( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_41782c565fbd7fd5_269_set_size)
...
HXLINE( 286)					 ::openfl::geom::Matrix object;
HXLINE( 288)					{
...
HXLINE( 290)							object = ( ( ::openfl::geom::Matrix)(this->create()) );
