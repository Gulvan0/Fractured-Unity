...
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_61_destroyContext,"lime.media.ALCAudioContext","destroyContext",0xfe557f55,"lime.media.ALCAudioContext.destroyContext","lime/media/ALCAudioContext.hx",61,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_69_getContextsDevice,"lime.media.ALCAudioContext","getContextsDevice",0x539c7b50,"lime.media.ALCAudioContext.getContextsDevice","lime/media/ALCAudioContext.hx",69,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_79_getCurrentContext,"lime.media.ALCAudioContext","getCurrentContext",0x508a46ac,"lime.media.ALCAudioContext.getCurrentContext","lime/media/ALCAudioContext.hx",79,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_86_getError,"lime.media.ALCAudioContext","getError",0xa27ae692,"lime.media.ALCAudioContext.getError","lime/media/ALCAudioContext.hx",86,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_93_getErrorString,"lime.media.ALCAudioContext","getErrorString",0xffadbd03,"lime.media.ALCAudioContext.getErrorString","lime/media/ALCAudioContext.hx",93,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_100_getIntegerv,"lime.media.ALCAudioContext","getIntegerv",0x4f8a886e,"lime.media.ALCAudioContext.getIntegerv","lime/media/ALCAudioContext.hx",100,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_107_getString,"lime.media.ALCAudioContext","getString",0x48d67ec7,"lime.media.ALCAudioContext.getString","lime/media/ALCAudioContext.hx",107,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_114_makeContextCurrent,"lime.media.ALCAudioContext","makeContextCurrent",0x06ff07d8,"lime.media.ALCAudioContext.makeContextCurrent","lime/media/ALCAudioContext.hx",114,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_121_openDevice,"lime.media.ALCAudioContext","openDevice",0xe997a340,"lime.media.ALCAudioContext.openDevice","lime/media/ALCAudioContext.hx",121,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_128_pauseDevice,"lime.media.ALCAudioContext","pauseDevice",0x6df540ec,"lime.media.ALCAudioContext.pauseDevice","lime/media/ALCAudioContext.hx",128,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_135_processContext,"lime.media.ALCAudioContext","processContext",0x4447d280,"lime.media.ALCAudioContext.processContext","lime/media/ALCAudioContext.hx",135,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_142_resumeDevice,"lime.media.ALCAudioContext","resumeDevice",0xa7c76563,"lime.media.ALCAudioContext.resumeDevice","lime/media/ALCAudioContext.hx",142,0x002ac592)
HX_LOCAL_STACK_FRAME(_hx_pos_7ddeb74c457c1c3a_149_suspendContext,"lime.media.ALCAudioContext","suspendContext",0x772eb113,"lime.media.ALCAudioContext.suspendContext","lime/media/ALCAudioContext.hx",149,0x002ac592)
namespace lime{
namespace media{
...
void ALCAudioContext_obj::destroyContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_61_destroyContext)
HXLINE(  63)		if (hx::IsNull( context )) {
HXLINE(  63)			return;
            		}
HXLINE(  64)		::lime::media::openal::ALC_obj::destroyContext(context);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,destroyContext,(void))
 ...
 ::Dynamic ALCAudioContext_obj::getContextsDevice( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_69_getContextsDevice)
HXLINE(  71)		if (hx::IsNull( context )) {
HXLINE(  71)			return null();
            		}
HXLINE(  72)		return ::lime::media::openal::ALC_obj::getContextsDevice(context);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,getContextsDevice,return )
 ...
 ::Dynamic ALCAudioContext_obj::getCurrentContext(){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_79_getCurrentContext)
HXDLIN(  79)		return ::lime::media::openal::ALC_obj::getCurrentContext();
            	}
...
int ALCAudioContext_obj::getError( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_86_getError)
HXDLIN(  86)		return ::lime::media::openal::ALC_obj::getError(device);
            	}
...
::String ALCAudioContext_obj::getErrorString( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_93_getErrorString)
HXDLIN(  93)		return ::lime::media::openal::ALC_obj::getErrorString(device);
            	}
...
int count = __o_count.Default(1);
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_100_getIntegerv)
HXDLIN( 100)		return ::lime::media::openal::ALC_obj::getIntegerv(device,param,count);
            	}
...
::String ALCAudioContext_obj::getString( ::Dynamic device,int param){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_107_getString)
HXDLIN( 107)		return ::lime::media::openal::ALC_obj::getString(device,param);
            	}
...
bool ALCAudioContext_obj::makeContextCurrent( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_114_makeContextCurrent)
HXDLIN( 114)		return ::lime::media::openal::ALC_obj::makeContextCurrent(context);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ALCAudioContext_obj,makeContextCurrent,return )
 ...
 ::Dynamic ALCAudioContext_obj::openDevice(::String deviceName){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_121_openDevice)
HXDLIN( 121)		return ::lime::media::openal::ALC_obj::openDevice(deviceName);
            	}
...
void ALCAudioContext_obj::pauseDevice( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_128_pauseDevice)
HXDLIN( 128)		::lime::media::openal::ALC_obj::pauseDevice(device);
            	}
...
void ALCAudioContext_obj::processContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_135_processContext)
HXDLIN( 135)		::lime::media::openal::ALC_obj::processContext(context);
            	}
...
void ALCAudioContext_obj::resumeDevice( ::Dynamic device){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_142_resumeDevice)
HXDLIN( 142)		::lime::media::openal::ALC_obj::resumeDevice(device);
            	}
...
void ALCAudioContext_obj::suspendContext( ::Dynamic context){
            	HX_STACKFRAME(&_hx_pos_7ddeb74c457c1c3a_149_suspendContext)
HXDLIN( 149)		::lime::media::openal::ALC_obj::suspendContext(context);
            	}
