...
HX_DEFINE_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1135_new,"lime._backend.native._NativeApplication.TouchEventInfo","new",0x974ae818,"lime._backend.native._NativeApplication.TouchEventInfo.new","lime/_backend/native/NativeApplication.hx",1135,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_afd93a4eedeb9e3f_1151_clone,"lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1151,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int device = __o_device.Default(0);
            	HX_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1135_new)
HXLINE(1137)		this->type = type;
HXLINE(1138)		this->x = x;
HXLINE(1139)		this->y = y;
HXLINE(1140)		this->id = id;
HXLINE(1141)		this->dx = dx;
HXLINE(1142)		this->dy = dy;
HXLINE(1143)		this->pressure = pressure;
HXLINE(1144)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_afd93a4eedeb9e3f_1151_clone)
HXDLIN(1151)		return  ::lime::_backend::native::_NativeApplication::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
