...
HX_DEFINE_STACK_FRAME(_hx_pos_07695e5bd07fa57d_1054_new,"lime._backend.native._NativeApplication.SensorEventInfo","new",0x51c6b8a3,"lime._backend.native._NativeApplication.SensorEventInfo.new","lime/_backend/native/NativeApplication.hx",1054,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_07695e5bd07fa57d_1067_clone,"lime._backend.native._NativeApplication.SensorEventInfo","clone",0x0a92d260,"lime._backend.native._NativeApplication.SensorEventInfo.clone","lime/_backend/native/NativeApplication.hx",1067,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float z = __o_z.Default(0);
            	HX_STACKFRAME(&_hx_pos_07695e5bd07fa57d_1054_new)
HXLINE(1056)		this->type = type;
HXLINE(1057)		this->id = id;
HXLINE(1058)		this->x = x;
HXLINE(1059)		this->y = y;
HXLINE(1060)		this->z = z;
            	}
...
bool SensorEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_07695e5bd07fa57d_1067_clone)
HXDLIN(1067)		return  ::lime::_backend::native::_NativeApplication::SensorEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->x,this->y,this->z);
            	}
