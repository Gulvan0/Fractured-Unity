...
HX_DEFINE_STACK_FRAME(_hx_pos_e3566ee739d748b6_977_new,"lime._backend.native._NativeApplication.MouseEventInfo","new",0x1e4161f2,"lime._backend.native._NativeApplication.MouseEventInfo.new","lime/_backend/native/NativeApplication.hx",977,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_e3566ee739d748b6_992_clone,"lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",992,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float movementY = __o_movementY.Default(0);
            	HX_STACKFRAME(&_hx_pos_e3566ee739d748b6_977_new)
HXLINE( 979)		this->type = type;
HXLINE( 980)		this->windowID = (int)0;
HXLINE( 981)		this->x = x;
HXLINE( 982)		this->y = y;
HXLINE( 983)		this->button = button;
HXLINE( 984)		this->movementX = movementX;
HXLINE( 985)		this->movementY = movementY;
            	}
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e3566ee739d748b6_992_clone)
HXDLIN( 992)		return  ::lime::_backend::native::_NativeApplication::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
