...
HX_DEFINE_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1179_new,"lime._backend.native._NativeApplication.WindowEventInfo","new",0xd11afd2d,"lime._backend.native._NativeApplication.WindowEventInfo.new","lime/_backend/native/NativeApplication.hx",1179,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1193_clone,"lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",1193,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_a59bd2e504ea207a_1179_new)
HXLINE(1181)		this->type = type;
HXLINE(1182)		this->windowID = windowID;
HXLINE(1183)		this->width = width;
HXLINE(1184)		this->height = height;
HXLINE(1185)		this->x = x;
HXLINE(1186)		this->y = y;
            	}
...
bool WindowEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a59bd2e504ea207a_1193_clone)
HXDLIN(1193)		return  ::lime::_backend::native::_NativeApplication::WindowEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
