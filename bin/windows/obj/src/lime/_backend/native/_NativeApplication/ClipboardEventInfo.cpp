...
HX_DEFINE_STACK_FRAME(_hx_pos_e537199fee37e312_785_new,"lime._backend.native._NativeApplication.ClipboardEventInfo","new",0x1badfa21,"lime._backend.native._NativeApplication.ClipboardEventInfo.new","lime/_backend/native/NativeApplication.hx",785,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_e537199fee37e312_792_clone,"lime._backend.native._NativeApplication.ClipboardEventInfo","clone",0x8debef5e,"lime._backend.native._NativeApplication.ClipboardEventInfo.clone","lime/_backend/native/NativeApplication.hx",792,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
void ClipboardEventInfo_obj::__construct( ::Dynamic type){
            	HX_STACKFRAME(&_hx_pos_e537199fee37e312_785_new)
HXDLIN( 785)		this->type = type;
            	}
...
bool ClipboardEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::ClipboardEventInfo ClipboardEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e537199fee37e312_792_clone)
HXDLIN( 792)		return  ::lime::_backend::native::_NativeApplication::ClipboardEventInfo_obj::__alloc( HX_CTX ,this->type);
            	}
