...
HX_DEFINE_STACK_FRAME(_hx_pos_7f39e850c253c633_1017_new,"lime._backend.native._NativeApplication.RenderEventInfo","new",0xcf12fe07,"lime._backend.native._NativeApplication.RenderEventInfo.new","lime/_backend/native/NativeApplication.hx",1017,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_7f39e850c253c633_1027_clone,"lime._backend.native._NativeApplication.RenderEventInfo","clone",0xa78638c4,"lime._backend.native._NativeApplication.RenderEventInfo.clone","lime/_backend/native/NativeApplication.hx",1027,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
void RenderEventInfo_obj::__construct( ::Dynamic type, ::lime::graphics::RenderContext context){
            	HX_STACKFRAME(&_hx_pos_7f39e850c253c633_1017_new)
HXLINE(1019)		this->type = type;
HXLINE(1020)		this->context = context;
            	}
...
bool RenderEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::RenderEventInfo RenderEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_7f39e850c253c633_1027_clone)
HXDLIN(1027)		return  ::lime::_backend::native::_NativeApplication::RenderEventInfo_obj::__alloc( HX_CTX ,this->type,this->context);
            	}
