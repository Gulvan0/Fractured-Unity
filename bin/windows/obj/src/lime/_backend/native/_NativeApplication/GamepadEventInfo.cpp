...
HX_DEFINE_STACK_FRAME(_hx_pos_3b7a66bddb205621_849_new,"lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",849,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_3b7a66bddb205621_862_clone,"lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",862,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float value = __o_value.Default(0);
            	HX_STACKFRAME(&_hx_pos_3b7a66bddb205621_849_new)
HXLINE( 851)		this->type = type;
HXLINE( 852)		this->id = id;
HXLINE( 853)		this->button = button;
HXLINE( 854)		this->axis = axis;
HXLINE( 855)		this->value = value;
            	}
...
bool GamepadEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3b7a66bddb205621_862_clone)
HXDLIN( 862)		return  ::lime::_backend::native::_NativeApplication::GamepadEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->button,this->axis,this->value);
            	}
