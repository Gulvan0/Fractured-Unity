...
HX_DEFINE_STACK_FRAME(_hx_pos_4c8f67ddac45293c_892_new,"lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",892,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_4c8f67ddac45293c_906_clone,"lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",906,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4c8f67ddac45293c_892_new)
HXLINE( 894)		this->type = type;
HXLINE( 895)		this->id = id;
HXLINE( 896)		this->index = index;
HXLINE( 897)		this->value = value;
HXLINE( 898)		this->x = x;
HXLINE( 899)		this->y = y;
            	}
...
bool JoystickEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_4c8f67ddac45293c_906_clone)
HXDLIN( 906)		return  ::lime::_backend::native::_NativeApplication::JoystickEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->index,this->value,this->x,this->y);
            	}
