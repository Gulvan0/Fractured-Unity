...
HX_DEFINE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_751_new,"lime._backend.native._NativeApplication.ApplicationEventInfo","new",0x285f59a7,"lime._backend.native._NativeApplication.ApplicationEventInfo.new","lime/_backend/native/NativeApplication.hx",751,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_761_clone,"lime._backend.native._NativeApplication.ApplicationEventInfo","clone",0x3158bc64,"lime._backend.native._NativeApplication.ApplicationEventInfo.clone","lime/_backend/native/NativeApplication.hx",761,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int deltaTime = __o_deltaTime.Default(0);
            	HX_STACKFRAME(&_hx_pos_e0c2b4da9d832f26_751_new)
HXLINE( 753)		this->type = type;
HXLINE( 754)		this->deltaTime = deltaTime;
            	}
...
bool ApplicationEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e0c2b4da9d832f26_761_clone)
HXDLIN( 761)		return  ::lime::_backend::native::_NativeApplication::ApplicationEventInfo_obj::__alloc( HX_CTX ,this->type,this->deltaTime);
            	}
