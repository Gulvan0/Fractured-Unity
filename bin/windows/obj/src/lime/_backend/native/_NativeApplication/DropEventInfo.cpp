...
HX_DEFINE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_814_new,"lime._backend.native._NativeApplication.DropEventInfo","new",0x5891dece,"lime._backend.native._NativeApplication.DropEventInfo.new","lime/_backend/native/NativeApplication.hx",814,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_cc1242aa9b04079d_824_clone,"lime._backend.native._NativeApplication.DropEventInfo","clone",0xb714194b,"lime._backend.native._NativeApplication.DropEventInfo.clone","lime/_backend/native/NativeApplication.hx",824,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
void DropEventInfo_obj::__construct( ::Dynamic type,::String file){
            	HX_STACKFRAME(&_hx_pos_cc1242aa9b04079d_814_new)
HXLINE( 816)		this->type = type;
HXLINE( 817)		this->file = file;
            	}
...
bool DropEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::DropEventInfo DropEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_cc1242aa9b04079d_824_clone)
HXDLIN( 824)		return  ::lime::_backend::native::_NativeApplication::DropEventInfo_obj::__alloc( HX_CTX ,this->type,this->file);
            	}
