...
HX_DEFINE_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_1093_new,"lime._backend.native._NativeApplication.TextEventInfo","new",0xb1ead390,"lime._backend.native._NativeApplication.TextEventInfo.new","lime/_backend/native/NativeApplication.hx",1093,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_1106_clone,"lime._backend.native._NativeApplication.TextEventInfo","clone",0xd025428d,"lime._backend.native._NativeApplication.TextEventInfo.clone","lime/_backend/native/NativeApplication.hx",1106,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
int length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_d4a11b6fb4b30fe3_1093_new)
HXLINE(1095)		this->type = type;
HXLINE(1096)		this->windowID = windowID;
HXLINE(1097)		this->text = text;
HXLINE(1098)		this->start = start;
HXLINE(1099)		this->length = length;
            	}
...
bool TextEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_backend::native::_NativeApplication::TextEventInfo TextEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d4a11b6fb4b30fe3_1106_clone)
HXDLIN(1106)		return  ::lime::_backend::native::_NativeApplication::TextEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->text,this->start,this->length);
            	}
