...
HXLINE(  56)		{
HXLINE(  56)			::String v = (rootPath + HX_("lib/AssetSource.json",f5,77,88,e0));
HXDLIN(  56)			::lime::utils::Assets_obj::libraryPaths->set(HX_("AssetSource",cb,3a,c6,ab),v);
            		}
HXLINE(  57)		data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXLINE(  58)		manifest = ::lime::utils::AssetManifest_obj::parse(data,rootPath);
HXLINE(  59)		library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE(  60)		::lime::utils::Assets_obj::registerLibrary(HX_("default",c1,d8,c3,9b),library);
HXLINE(  63)		library = ::lime::utils::Assets_obj::getLibrary(HX_("AssetSource",cb,3a,c6,ab));
HXLINE(  64)		if (hx::IsNotNull( library )) {
HXLINE(  64)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  65)			::ManifestResources_obj::preloadLibraryNames->push(HX_("AssetSource",cb,3a,c6,ab));
            		}
HXLINE(  66)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  67)		if (hx::IsNotNull( library )) {
HXLINE(  67)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  68)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
