...
HXDLIN(  40)		_hx_tmp->lineStyle((int)3,this->darken(colour),(int)1,false,(int)2,(int)1,(int)1,(int)3);
HXLINE(  41)		 ::openfl::display::Graphics _hx_tmp1 = this->get_graphics();
HXDLIN(  41)		_hx_tmp1->beginFill(this->darken(colour),null());
...
HXLINE(  46)		 ::openfl::display::Graphics _hx_tmp2 = this->get_graphics();
HXDLIN(  46)		_hx_tmp2->drawRect(((Float)1.5),((Float)1.5),(fillWidth - (int)3),(this->barHeight - (int)3));
