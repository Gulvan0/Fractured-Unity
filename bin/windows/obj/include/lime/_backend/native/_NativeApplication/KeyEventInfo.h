...
HX_DECLARE_STACK_FRAME(_hx_pos_4be9d6956d8ea946_936_new)
...
HXLINE( 938)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->type = type;
HXLINE( 939)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 940)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 941)		( ( ::lime::_backend::native::_NativeApplication::KeyEventInfo)(__this) )->modifier = modifier;
            	}
