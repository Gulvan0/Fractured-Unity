...
HX_DECLARE_STACK_FRAME(_hx_pos_e3566ee739d748b6_977_new)
...
HXLINE( 979)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->type = type;
HXLINE( 980)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->windowID = (int)0;
HXLINE( 981)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->x = x;
HXLINE( 982)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->y = y;
HXLINE( 983)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->button = button;
HXLINE( 984)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 985)		( ( ::lime::_backend::native::_NativeApplication::MouseEventInfo)(__this) )->movementY = movementY;
            	}
