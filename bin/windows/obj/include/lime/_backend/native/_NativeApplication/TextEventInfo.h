...
HX_DECLARE_STACK_FRAME(_hx_pos_d4a11b6fb4b30fe3_1093_new)
...
HXLINE(1095)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->type = type;
HXLINE(1096)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->windowID = windowID;
HXLINE(1097)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->text = text;
HXLINE(1098)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->start = start;
HXLINE(1099)		( ( ::lime::_backend::native::_NativeApplication::TextEventInfo)(__this) )->length = length;
            	}
