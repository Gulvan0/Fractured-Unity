...
HX_DECLARE_STACK_FRAME(_hx_pos_a59bd2e504ea207a_1179_new)
...
HXLINE(1181)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->type = type;
HXLINE(1182)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE(1183)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->width = width;
HXLINE(1184)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->height = height;
HXLINE(1185)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->x = x;
HXLINE(1186)		( ( ::lime::_backend::native::_NativeApplication::WindowEventInfo)(__this) )->y = y;
            	}
