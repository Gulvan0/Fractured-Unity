...
HX_DECLARE_STACK_FRAME(_hx_pos_cc1242aa9b04079d_814_new)
...
HXLINE( 816)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->type = type;
HXLINE( 817)		( ( ::lime::_backend::native::_NativeApplication::DropEventInfo)(__this) )->file = file;
            	}
