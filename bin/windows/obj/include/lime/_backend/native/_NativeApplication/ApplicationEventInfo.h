...
HX_DECLARE_STACK_FRAME(_hx_pos_e0c2b4da9d832f26_751_new)
...
HXLINE( 753)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->type = type;
HXLINE( 754)		( ( ::lime::_backend::native::_NativeApplication::ApplicationEventInfo)(__this) )->deltaTime = deltaTime;
            	}
